			...
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12 bigImage">
								<img src="image/homePage.jpg" height="350px" width="100%"/>
							</div>
						</div>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12 ">
								<img src="image/Weight.jpg" height="330px" width="33%"/>
								<img src="image/fish2.jpg" height="330px" width="33%"/>
								<img src="image/fish3.jpg" height="330px" width="33%"/>
							</div>
						</div>
