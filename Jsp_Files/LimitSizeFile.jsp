...
<tr><!--<td><i>Select files:</i></tr></td>--><button><input id="bro" type="file" value="browse" name="image" accept="image/*" onchange="preview_image(event)"></button><input type="submit" value="upload"></td><td style="color:pink">Please select within 8 mb files</td></tr>
</table>
