...
<%@ page import="servletpk.SendMailServlet" %>
...
<%
	...
	try{
		while(rs.next())
		{
		imagepath=rs.getString("IMAGENAME");
		path=email+"ImageFolder/"+imagepath;
		
	%>
	
		<img src="<%=path%>" height="200px" width="200px" id="myimg" />
		
		<a href="SheImg.jsp?imgpath=<%=path %>" class="button">Shear</a>
