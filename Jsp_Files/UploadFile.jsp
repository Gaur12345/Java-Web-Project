...
<tr><!--<td><i>Select files:</i></tr></td>--><button><input id="bro" type="file" value="browse" name="image" accept="All files/*" onchange="preview_image(event)"></button><input type="submit" value="upload"></tr>
</table>
</form>
<table><tr>
