	   ...
	   <form action="RegistrationServlet" method="post">
		<div class="header">
			...
			<table align="center" cellspacing="30">
				...
				<tr><td>Mobile-No</td><td><input type="number" name="mobile" id="mobnumber" required placeholder="Mobile no also register"/></td><td><span id="num1" style="color:red"></span></td></tr>
